...
export interface MobileWarehouseItemProfilePayload { id:number;writeMode:'MOBILE_PROFILE';code:string;name:string;categoryId:number;imageUrl?:string;unit?:string;purchaseUnit?:string;stockUnit?:string;ingredientUnit?:string;unitConversionText?:string;spec?:string;warehouseLocation?:string;unitPrice?:number;shelfLifeDays?:number;minStockQuantity?:number;expiryAlertDays?:number;itemDescription?:string;itemAttributes?:string }
export interface MobileWarehouseItemFullPayload { id?:number;writeMode?:'FULL';code:string;name:string;categoryId:number;imageUrl?:string;unit?:string;purchaseUnit?:string;stockUnit?:string;ingredientUnit?:string;unitConversionText?:string;spec?:string;warehouseLocation?:string;unitPrice?:number;shelfLifeDays?:number;minStockQuantity?:number;alertEnabled?:boolean;expiryAlertDays?:number;itemDescription?:string;sortOrder?:number;itemAttributes?:string;active?:boolean;departments?:Array<{departmentName:string;departmentCode?:string;departmentGroup?:string;purchaseMethod?:string;supplierName?:string}> }
export type MobileWarehouseItemPayload = MobileWarehouseItemProfilePayload | MobileWarehouseItemFullPayload
