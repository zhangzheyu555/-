  ...
  void roleResolveWritesOperationLogForAuditReview() {
    ...
    assertThat(jdbcTemplate.queryForObject(
        ...
        where tenant_id = 1
          ...
          and target_id = 'profit-risk-s1-2026-07'
          and store_id = 's1'
          and month = '2026-07'
