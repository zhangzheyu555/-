...
class HealthControllerTest {
  ...
  void reportsSanitizedRuntimeDatabaseIdentity() throws Exception {
    ...
    HealthController controller = new HealthController(buildProperties, flyway, dataSource);
    ReflectionTestUtils.setField(controller, "applicationEnvironment", "STAGING");
    ReflectionTestUtils.setField(controller, "inspectionDetectUrl", "http://127.0.0.1:8000/detect");
