alter table store_requisition add column if not exists received_by bigint null;
alter table store_requisition add column if not exists received_at timestamp null default null;
alter table store_requisition add column if not exists received_note text null;
