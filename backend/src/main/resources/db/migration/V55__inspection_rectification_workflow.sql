create table if not exists inspection_rectification (
  ...
  unique key uk_inspection_rectification_record (tenant_id, inspection_record_id),
  index idx_inspection_rectification_queue (tenant_id, status, store_id, updated_at),
...
create table if not exists inspection_rectification_action (
  ...
  created_at timestamp not null default current_timestamp,
  index idx_inspection_rectification_action_record (tenant_id, inspection_record_id, created_at),
  index idx_inspection_rectification_action_rectification (tenant_id, rectification_id, created_at),
