...
export const roles: RoleConfig[] = [
  ...
  },
  {
    ...
    expectedMenus: ['财务工作台', '报销栏', '利润表', '数据录入', '员工工资', '数据导出', '店铺盘存', '门店经营助手'],
  ...
  },
  {
    ...
    expectedMenus: ['仓库中心', '店铺盘存', '门店经营助手'],
  ...
  },
  {
    ...
    expectedMenus: ['督导工作台', '每日报损', '督导巡店', '店铺盘存', '培训考试', '平台配置'],
  ...
  },
  {
    ...
    forbiddenMenus: ['老板工作台', '财务工作台', '仓库工作台', '门店工作台', '运营工作台', '店铺盘存', '账号权限', '导入月度汇总'],
    layout: 'app',
  },
]
