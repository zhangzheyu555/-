...
const contracts = {
  SUPERVISOR: {
    ...
    expectedMenus: ['督导工作台', '每日报损', '督导巡店', '整改复核', '培训考试', '平台配置'],
    forbiddenMenus: ['运营工作台', '运营中心', '财务工作台', '老板工作台', '仓库中心', '账号权限'],
    routeDenials: [],
    routeAllows: [
  ...
  STORE_MANAGER: {
    ...
    expectedMenus: ['利润概览', '利润表', '数据录入', '报销栏', '本店工资核对', '仓库中心', '每日报损', '巡检记录', '巡检整改', '培训考试', '门店经营助手'],
    forbiddenMenus: ['运营工作台', '平台配置', '老板工作台', '财务工作台', '账号权限', '整改复核'],
    routeDenials: ['/operations', '/platform-login', { from: '/boss', to: '/profit' }, '/finance'],
    routeAllows: [
  ...
  FINANCE: {
    ...
    forbiddenMenus: ['运营工作台', '平台配置', '培训考试', '老板工作台', '账号权限', '门店工作台', '每日报损'],
    routeDenials: ['/operations', '/platform-login', '/boss', '/store', '/daily-loss'],
    routeAllows: [],
  },
  EMPLOYEE: {
    name: '员工验收',
  ...
  BOSS: {
    ...
    expectedMenus: ['老板工作台', '利润概览', '仓库中心', '每日报损', '督导巡店', '培训考试', '平台配置', '账号权限'],
    forbiddenMenus: [],
    routeAllows: [
      { from: '/operations', to: '/operations' },
      { from: '/finance', to: '/finance' },
      { from: '/store', to: '/profit' },
