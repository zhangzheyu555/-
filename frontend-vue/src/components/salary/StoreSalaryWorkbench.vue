    ...
    <div class="table-tools">
      ...
      <div>
        <button
          v-if="page.canEdit.value"
          class="batch-button"
          :disabled="selectedGenerationEmployeeIds.size === 0 || salaryOperationBusy"
        ...
        <button v-if="page.canReview.value" class="batch-button" :disabled="selectedApprovalRecordIds.size === 0 || salaryOperationBusy" @click="batchApprove"><Check :size="16" />批量审核<span v-if="selectedApprovalRecordIds.size">（{{ selectedApprovalRecordIds.size }}）</span></button>
