...
const routes: RouteRecordRaw[] = [
  { path: '/login', name: 'login', component: LoginPage },
  {
    ...
    children: [
      ...
      { path: 'warehouse', name: 'warehouse', component: WarehousePage, meta: { roles: ['ADMIN', 'BOSS', 'OWNER', 'WAREHOUSE', 'STORE_MANAGER', 'FINANCE'] } },
      { path: 'warehouse/items', name: 'warehouse-items', component: WarehousePage, meta: { roles: ['ADMIN', 'BOSS', 'OWNER', 'WAREHOUSE', 'FINANCE'], warehouseTab: 'inventory', title: '商品档案' } },
      ...
      { path: 'warehouse/movements', name: 'warehouse-movements', component: WarehousePage, meta: { roles: ['ADMIN', 'BOSS', 'OWNER', 'WAREHOUSE', 'FINANCE'], warehouseTab: 'movements', title: '出入库记录' } },
      { path: 'warehouse/returns', name: 'warehouse-returns', component: WarehousePage, meta: { roles: ['ADMIN', 'BOSS', 'OWNER', 'WAREHOUSE', 'STORE_MANAGER', 'FINANCE'], warehouseTab: 'returns', title: '配送退货单' } },
      { path: 'warehouse/alerts', name: 'warehouse-alerts', component: WarehousePage, meta: { roles: ['ADMIN', 'BOSS', 'OWNER', 'WAREHOUSE'], warehouseTab: 'alerts', title: '库存预警' } },
      { path: 'warehouse/receipts', name: 'warehouse-receipts', component: WarehousePage, meta: { roles: ['ADMIN', 'BOSS', 'OWNER', 'WAREHOUSE', 'FINANCE'], warehouseTab: 'receipts', title: '入库记录' } },
