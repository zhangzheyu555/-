...
const appChildren: RouteRecordRaw[] = [
  ...
  { path: 'warehouse/returns', name: 'warehouse-returns', component: CentralWarehouseWorkspace, meta: permissionMeta(PERMISSIONS.WAREHOUSE_READ, { moduleKey: 'warehouse', menuKey: 'warehouse-center', warehouseTab: 'returns', title: '配送退货单' }) },
